...
void *generate_gradient(int xsize, int ysize, int start_row, int end_row, double complex c_L, double complex c_R, int max_iter, int rank){
    ...
    #pragma omp parallel 
    {
        ...
        //int myid = rank * total_threads + global_id;
        //printf("my rank %d is:\n myid: %d\n",rank, myid);
...
int main(int argc, char **argv){
    ...
    void *local_image = generate_gradient(xsize, ysize, start_row, end_row, c_L, c_R, max_iter, rank);
    ...
    if (rank == 0){
        ...
        printf("Total time in %.2f seconds:\n", elapsed_time);
